...
| [data_5090/](data_5090/) | **⚠ MOCK RTX 5090 dataset** — synthesized from the H200 fits x 5090 spec ratios (no measurement); same format/pipeline, figures in [workload_analysis/5090/](workload_analysis/5090/), all titles carry the MOCK tag | [README.md](data_5090/README.md) |
